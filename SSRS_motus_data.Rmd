...
# Migrant corner
# rec_id =  "CTT-1F618DF06116"
# Red tail Hill (RTH)
rec_id =  "CTT-957865AC5BF7"
...
# Whole time
(time_range = c("2022-07-02", "2023-03-21"))
# Cookie
# tag_motus_id = 65544 # YBCU Cookie
(time_range = c("2022-07-02", "2022-07-17"))
#  Short time on >1 antenna Migrant corner
(time_range = c("2022-07-07", "2022-07-09"))
#  Short time on >1 antenna RTH
(time_range = c("2022-07-13", "2022-07-14"))
# tag_motus_id = 69554 # YBCU Cookie (2nd tag)
(time_range = c("2022-08-05", "2022-08-17"))
# tag_motus_id = 65557 # YBCU Stroopwafel
(time_range = c("2022-07-05", "2022-07-23"))
(time_range = c("2022-07-17", "2022-07-23"))
# tag_motus_id = 56746 # YBCU Stroopwafel (2nd tag)
(time_range = c("2022-08-03", "2022-08-09"))
# tag_motus_id = 56726 # YBCU Snickerdoodle
