...
This file is not set up to knit.  Run what you want.  You will need certain things to be in memory for motus_receiver_data.Rmd to run properly.
...
tbl.alltags <- tbl(proj.sql.motus, "alltags")
